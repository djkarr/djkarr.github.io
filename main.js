...
////////////////////////////////////////////////////////////////////
var init_js_stuff= true
///\bframes\.htm$/i.test(parent.location.pathname)
...
////////////////COPY TO CLIPBOARD/////////////////////////////////
// str is either "results" from vsearch.htm, or "listing" from listv.htm
function copy_to_clip(str)
{
  var results = document.getElementById(str);
  ...
  {  
   ...
   navigator.clipboard.writeText(verseBldr);
}
